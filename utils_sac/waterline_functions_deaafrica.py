# waterline_extraction.py from utils folder of deea africa https://github.com/digitalearthafrica/deafrica-sandbox-notebooks/blob/master/RCMRD_Demo/utils/waterline_funcs.py
"""
